# Base10 Manufacturing Research

Base10 thesis memo: automated manufacturing software infrastructure (control + ERP/MES).

**Live URL**: `https://ade-B10.github.io/manufacturing-research/`
...
2. Enter the team password (saved in 1Password under "Base10 Manufacturing Research")
...
```bash
cd /Users/ade/Desktop/Urizen/manufacturing-research-deploy

# 1. Drop the updated unencrypted HTML into source/
cp /Users/ade/Desktop/Urizen/Manufacturing_Research.html source/
...
# 3. Commit and push
git add index.html
git commit -m "Refresh Base10 Manufacturing Research ($(date +%Y-%m-%d))"
git push
```
